...
type BackrestState = {online:boolean; data_ready:boolean; valid:boolean; distance_mm:number|null; range_status:number};
type TelemetryPayload = {
  ...
  recognition_source:"rule"|"lightgbm"|"neural_network"|"mock";
